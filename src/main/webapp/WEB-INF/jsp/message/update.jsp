		...
		<div class="layui-row">
			<form class="layui-form">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" id="L_title" name="title" required=""
							...
							value="${message.title }" class="layui-input">
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" id="L_content" name="content" required=""
							...
							value="${message.content }" class="layui-input">
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						...
						<c:forEach items="${messageTypes }" var="messageType">
							<c:if test="${message.messageType.id eq messageType.id }">
								<input type="radio" name="messageType.id" value="${messageType.id }"
									title="${messageType.type }" checked="checked" />
							</c:if>

							<c:if test="${message.messageType.id ne messageType.id }">
								<input type="radio" name="messageType.id" value="${messageType.id }"
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="radio" name="user.id" value="${message.user.id }"
							title="${message.user.name }" checked="checked" />
					</div>
			</div>
