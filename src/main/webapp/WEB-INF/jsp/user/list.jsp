								...
								.render({
									...
									cols : [ [ //表头
											...
											},
											{
												...
												templet : function(obj) {
													if (obj.status == 1) {
														return "<div><input type=\"checkbox\" name=\"user\" class=\"user\" lay-skin=\"switch\"  lay-filter=\"user\" lay-text=\"开启|禁用\" value='"+obj.id+"'  checked></div>";
													} else {
														return "<div><input type=\"checkbox\" name=\"user\" class=\"user\" lay-skin=\"switch\"  lay-filter=\"user\" lay-text=\"开启|禁用\" value='"+obj.id+"' ></div>";
													}
											...
											},
											{
												...
												align : 'center',
												templet: function(obj){
													if(obj.dept.name==null){
														return "<div>无负责部门</div>";
													}else{
											...
											},
											{
												...
												align : 'center',
												templet: function(obj){
													if(obj.role.name==null){
														return "<div>无角色类型</div>";
													}else{
...
function delAll(argument) {
	...
	// 获取选中的id 
	$('tbody input:not(.user)').each(function(index, el) {
