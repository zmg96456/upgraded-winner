			...
			<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" id="L_id" name="id" required=""
							placeholder="请输入部门编号" lay-verify="id"  value="${dept.id }"  autocomplete="off"
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" id="L_name" name="name" required="" value="${dept.name }" 
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" id="L_phone" name="phone" required="" value="${dept.phone }" 
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" id="tel" name="tel" required=""
							placeholder="请输入部门电话"  lay-verify="tel" autocomplete="off"  value="${dept.tel }" 
							class="layui-input"   />
					</div>
				</div>
					...
					<div class="layui-input-block">
						...
						<c:forEach items="${branchs }" var="branch">
							...
							<c:if test="${dept.branch.id eq branch.id }">
								<input type="radio" name="branch.id" value="${branch.id }"  title="${branch.name }" checked="checked" />
							</c:if>
